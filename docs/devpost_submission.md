...
> **状态（2026-09-08）：这份交接单从未被使用——本项目没有提交到 Devpost。**
> 它记录的是当初照截止日 v1 版本（CLIP 单编码器、2000 张/类）准备好、但最终没有提交的内容。
> 之后仓库继续做到 v2（8000 张/类、加 DINOv2-small 融合与抖动训练视图）。**本仓不是参赛作品，不主张任何名次。**
